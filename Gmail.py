import requests, random, user_agent, secrets, os
import urllib3
...
class Gm:
    ...
    def check(self):
        try:
            ...
            response = requests.post(url, cookies=cookies, params=params, data=payload, headers=self.headers, timeout=10, proxies=proxy, verify=False)
            ...
            response = requests.post(url, params=params, cookies=cookies, headers=self.headers, data=data, timeout=10, proxies=proxy, verify=False)
